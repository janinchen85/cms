...
<nav class="navbar navbar-expand-md navbar-bg fixed-top w-100 justify-content-cente">
  ...
  <div class="collapse navbar-collapse w-100" id="navbarsExampleDefault">
    <ul class="navbar-nav mx-auto w-100 justify-content-center" id="menu">
      ...
      <li class="nav-item">
        <a class="nav-link active" data-menuanchor="forum" href="{$root}#forum">Forum</a>
      </li>
      <li class="nav-item">
